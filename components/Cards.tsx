    ...
    return (
        <TouchableOpacity onPress={onPress} className='flex flex-col item-start w-60 h-80 relative'>
            ...
            <View className='flex flex-row items-center bg-white/90 px-3 py-1.5 rounded-full absolute top-5 right-5'>
                ...
                <Text className='text-xs font-subik-bold text-primary-300 ml-1'>4.4</Text>
            </View>
    ...
    return (
        <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
            <View className='flex flex-row items-center absolute px-3 top-5 right-5 bg-white/90 p-1 rounded -full z-50'>
                ...
                <Text className='text-xs font-subik-bold text-primary-300 ml-0.5'>4.4</Text>
            </View>
            <Image source={images.newYork} className='w-full h-40 rounded-lg' />
            <View className='flex flex-col mt-2'>
                <Text className='text-bas font-rubik-bold text-black-300' numberOfLines={1}>Cozy Studio</Text>
